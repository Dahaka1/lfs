...
async def create_station(
	...
	Программы станции должны быть обязательно определены либо по умолчанию (и валидированы), либо
	 при создании станции. Без программ создание станции невозможно - будет ошибка 422.
	...
	По умолчанию программы станции автоматически "подтягиваются" из предопределенных дефолтных.
	Но если передать кастомные программы при создании станции - создадутся только переданные.
